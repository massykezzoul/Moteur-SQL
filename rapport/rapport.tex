...
La jointure est un produit cartésien entre deux ou plusieurs tables données par l'utilisateur suivit d'une sélection, 
les tables données sont spécifier dans la partie FROM de la requête SQL.

Le produit cartésien entre une table A et B est une table composée de l'ensemble des couples possible entre leurs éléments respectives, ainsi nous aurons en résultat une table A*B.
...
\begin{figure}[h]
	...
	\begin{figure}[h]
		...
		\begin{tabular}
			...
			03 & Emp3 &  29  & 01 & Dep1 &  Montpellier \\
			\hline
		\end{tabular}
	\end{figure}
	\begin{figure}[h]
		...
		\begin{tabular}
			...
			01 & Emp1 &  30  & 01 & Dep1 &  Montpellier \\
			02 & Emp2 &  31  & 01 & Dep1 &  Montpellier \\
			03 & Emp3 &  29  & 02 & Dep2 &  Montpellier \\
			\hline
		\end{tabular}
	\end{figure}
